...
public class ReaderExample extends HttpServlet {
	private static final long serialVersionUID = 2341494330662222339L;
	...
	protected void processRequest(HttpServletRequest request,
		...
		try (PrintWriter out = response.getWriter()) {
			...
			out.println("</head>");
			out.println("<body>");
			out.println("<h1>Servlet ReaderExample at "
			...
			Logger.getLogger(ReaderExample.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}
